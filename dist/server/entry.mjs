...
function deserializeActionResult(res) {
  if (res.type === "error") {
    ...
    if (Object.assign(__vite_import_meta_env__$1, { _: "/Users/Rohin1/code/github.com/website/node_modules/.bin/astro" })?.PROD) {
...
function serializeActionResult(res) {
  if (res.error) {
    if (Object.assign(__vite_import_meta_env__, { _: "/Users/Rohin1/code/github.com/website/node_modules/.bin/astro" })?.DEV) {
...
const _manifest = deserializeManifest({"rootDir":"file:///Users/Rohin1/code/github.com/website/","cacheDir":"file:///Users/Rohin1/code/github.com/website/node_modules/.astro/","outDir":"file:///Users/Rohin1/code/github.com/website/dist/","srcDir":"file:///Users/Rohin1/code/github.com/website/src/","publicDir":"file:///Users/Rohin1/code/github.com/website/public/","buildClientDir":"file:///Users/Rohin1/code/github.com/website/dist/client/","buildServerDir":"file:///Users/Rohin1/code/github.com/website/dist/server/","adapterName":"@astrojs/cloudflare","assetsDir":"_astro","routes":[{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"type":"page","component":"_server-islands.astro","params":["name"],"segments":[[{"content":"_server-islands","dynamic":false,"spread":false}],[{"content":"name","dynamic":true,"spread":false}]],"pattern":"^\\/_server-islands\\/([^/]+?)\\/?$","prerender":false,"isIndex":false,"fallbackRoutes":[],"route":"/_server-islands/[name]","origin":"internal","distURL":[],"_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"inline","content":":root{--bg: #faf8f5;--bg-sidebar: #f5f2ee;--text: #3b3b3b;--text-muted: #8a8a8a;--accent: #b07d4f;--accent-hover: #966a3f;--border: #e8e4df;--font-body: -apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, \"Helvetica Neue\", sans-serif;--font-heading: Georgia, \"Times New Roman\", serif}[data-theme=dark]{--bg: #1a1a2e;--bg-sidebar: #16162a;--text: #e0e0e0;--text-muted: #8888a0;--accent: #d4a574;--accent-hover: #e0b68a;--border: #2a2a4a}*,*:before,*:after{box-sizing:border-box}html,body{margin:0;padding:0;width:100%;min-height:100vh;background-color:var(--bg);color:var(--text);font-family:var(--font-body);font-size:16px;line-height:1.6;transition:background-color .2s ease,color .2s ease}a{color:var(--accent);text-decoration:none}a:hover{color:var(--accent-hover)}.theme-toggle[data-astro-cid-x3pjskd3]{position:fixed;top:1.25rem;right:1.25rem;z-index:100;background:none;border:none;cursor:pointer;color:var(--text-muted);padding:.5rem;border-radius:.5rem;transition:color .2s ease}.theme-toggle[data-astro-cid-x3pjskd3]:hover{color:var(--text)}.icon[data-astro-cid-x3pjskd3].sun{display:none}.icon[data-astro-cid-x3pjskd3].moon,[data-theme=dark] .icon[data-astro-cid-x3pjskd3].sun{display:block}[data-theme=dark] .icon[data-astro-cid-x3pjskd3].moon{display:none}\n.post[data-astro-cid-gysqo7gh]{max-width:640px;margin:0 auto;padding:3rem 2rem}.back-link[data-astro-cid-gysqo7gh]{display:inline-block;margin-bottom:2rem;font-size:.9rem;color:var(--text-muted)}.back-link[data-astro-cid-gysqo7gh]:hover{color:var(--accent)}h1[data-astro-cid-gysqo7gh]{font-family:var(--font-heading);font-size:2rem;font-weight:600;margin:0 0 .5rem;color:var(--text)}.post-date[data-astro-cid-gysqo7gh]{display:block;font-size:.88rem;color:var(--text-muted);margin-bottom:2rem}.post-body[data-astro-cid-gysqo7gh]{font-size:1.05rem;line-height:1.75;color:var(--text)}.post-body[data-astro-cid-gysqo7gh] h2{font-family:var(--font-heading);font-size:1.4rem;font-weight:600;margin:2rem 0 1rem;color:var(--text)}.post-body[data-astro-cid-gysqo7gh] p{margin:0 0 1.25rem}.post-body[data-astro-cid-gysqo7gh] strong{font-weight:600}@media(max-width:768px){.post[data-astro-cid-gysqo7gh]{padding:2rem 1.5rem}h1[data-astro-cid-gysqo7gh]{font-size:1.6rem}}\n"}],"routeData":{"route":"/posts/[slug]","isIndex":false,"type":"page","pattern":"^\\/posts\\/([^/]+?)\\/?$","segments":[[{"content":"posts","dynamic":false,"spread":false}],[{"content":"slug","dynamic":true,"spread":false}]],"params":["slug"],"component":"src/pages/posts/[slug].astro","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"inline","content":":root{--bg: #faf8f5;--bg-sidebar: #f5f2ee;--text: #3b3b3b;--text-muted: #8a8a8a;--accent: #b07d4f;--accent-hover: #966a3f;--border: #e8e4df;--font-body: -apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, \"Helvetica Neue\", sans-serif;--font-heading: Georgia, \"Times New Roman\", serif}[data-theme=dark]{--bg: #1a1a2e;--bg-sidebar: #16162a;--text: #e0e0e0;--text-muted: #8888a0;--accent: #d4a574;--accent-hover: #e0b68a;--border: #2a2a4a}*,*:before,*:after{box-sizing:border-box}html,body{margin:0;padding:0;width:100%;min-height:100vh;background-color:var(--bg);color:var(--text);font-family:var(--font-body);font-size:16px;line-height:1.6;transition:background-color .2s ease,color .2s ease}a{color:var(--accent);text-decoration:none}a:hover{color:var(--accent-hover)}.theme-toggle[data-astro-cid-x3pjskd3]{position:fixed;top:1.25rem;right:1.25rem;z-index:100;background:none;border:none;cursor:pointer;color:var(--text-muted);padding:.5rem;border-radius:.5rem;transition:color .2s ease}.theme-toggle[data-astro-cid-x3pjskd3]:hover{color:var(--text)}.icon[data-astro-cid-x3pjskd3].sun{display:none}.icon[data-astro-cid-x3pjskd3].moon,[data-theme=dark] .icon[data-astro-cid-x3pjskd3].sun{display:block}[data-theme=dark] .icon[data-astro-cid-x3pjskd3].moon{display:none}\n.sidebar[data-astro-cid-ssfzsv2f]{width:260px;min-height:100vh;padding:2rem 1.5rem;background-color:var(--bg-sidebar);border-right:1px solid var(--border);position:fixed;top:0;left:0;overflow-y:auto;transition:background-color .2s ease,border-color .2s ease}.site-title[data-astro-cid-ssfzsv2f]{font-family:var(--font-heading);font-size:1.25rem;font-weight:600;color:var(--text);display:block;margin-bottom:2rem}.site-title[data-astro-cid-ssfzsv2f]:hover{color:var(--accent)}.feed[data-astro-cid-ssfzsv2f] ul[data-astro-cid-ssfzsv2f]{list-style:none;margin:0;padding:0}.feed[data-astro-cid-ssfzsv2f] li[data-astro-cid-ssfzsv2f]{margin-bottom:.25rem}.feed[data-astro-cid-ssfzsv2f] li[data-astro-cid-ssfzsv2f] a[data-astro-cid-ssfzsv2f]{display:flex;flex-direction:column;padding:.5rem 0;color:var(--text);border-radius:.25rem;transition:color .15s ease}.feed[data-astro-cid-ssfzsv2f] li[data-astro-cid-ssfzsv2f] a[data-astro-cid-ssfzsv2f]:hover{color:var(--accent)}.entry-title[data-astro-cid-ssfzsv2f]{font-size:.9rem}.entry-date[data-astro-cid-ssfzsv2f]{font-size:.78rem;color:var(--text-muted)}@media(max-width:768px){.sidebar[data-astro-cid-ssfzsv2f]{position:static;width:100%;min-height:auto;border-right:none;border-bottom:1px solid var(--border)}}.main-content[data-astro-cid-ftvwmmpp]{max-width:640px;margin:0 auto;padding:4rem 2rem}h1[data-astro-cid-ftvwmmpp]{font-family:var(--font-heading);font-size:2rem;font-weight:600;margin:0 0 1.5rem;color:var(--text)}p[data-astro-cid-ftvwmmpp]{margin:0 0 1.25rem;color:var(--text);font-size:1.05rem;line-height:1.7}@media(max-width:768px){.main-content[data-astro-cid-ftvwmmpp]{padding:2rem 1.5rem}h1[data-astro-cid-ftvwmmpp]{font-size:1.6rem}}.page-layout[data-astro-cid-j7pv25f6]{display:flex;min-height:100vh}.content-area[data-astro-cid-j7pv25f6]{flex:1;margin-left:260px}@media(max-width:768px){.page-layout[data-astro-cid-j7pv25f6]{flex-direction:column}.content-area[data-astro-cid-j7pv25f6]{margin-left:0}}\n"}],"routeData":{"route":"/","isIndex":true,"type":"page","pattern":"^\\/$","segments":[],"params":[],"component":"src/pages/index.astro","pathname":"/","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}}],"serverLike":true,"middlewareMode":"classic","base":"/","trailingSlash":"ignore","compressHTML":true,"experimentalQueuedRendering":{"enabled":false,"poolSize":0,"contentCache":false},"componentMetadata":[["\u0000astro:content",{"propagation":"in-tree","containsHead":false}],["/Users/Rohin1/code/github.com/website/src/components/Sidebar.astro",{"propagation":"in-tree","containsHead":false}],["/Users/Rohin1/code/github.com/website/src/pages/index.astro",{"propagation":"in-tree","containsHead":true}],["\u0000virtual:astro:page:src/pages/index@_@astro",{"propagation":"in-tree","containsHead":false}],["\u0000virtual:astro:pages",{"propagation":"in-tree","containsHead":false}],["\u0000virtual:astro:manifest",{"propagation":"in-tree","containsHead":false}],["/Users/Rohin1/code/github.com/website/node_modules/astro/dist/core/app/entrypoints/virtual/prod.js",{"propagation":"in-tree","containsHead":false}],["\u0000virtual:astro:app",{"propagation":"in-tree","containsHead":false}],["/Users/Rohin1/code/github.com/website/node_modules/astro/dist/core/app/entrypoints/virtual/index.js",{"propagation":"in-tree","containsHead":false}],["/Users/Rohin1/code/github.com/website/node_modules/@astrojs/cloudflare/dist/utils/handler.js",{"propagation":"in-tree","containsHead":false}],["/Users/Rohin1/code/github.com/website/node_modules/@astrojs/cloudflare/dist/entrypoints/server.js",{"propagation":"in-tree","containsHead":false}],["\u0000virtual:cloudflare/worker-entry",{"propagation":"in-tree","containsHead":false}],["/Users/Rohin1/code/github.com/website/src/pages/posts/[slug].astro",{"propagation":"in-tree","containsHead":true}],["\u0000virtual:astro:page:src/pages/posts/[slug]@_@astro",{"propagation":"in-tree","containsHead":false}]],"renderers":[],"clientDirectives":[["idle","(()=>{var l=(n,t)=>{let i=async()=>{await(await n())()},e=typeof t.value==\"object\"?t.value:void 0,s={timeout:e==null?void 0:e.timeout};\"requestIdleCallback\"in window?window.requestIdleCallback(i,s):setTimeout(i,s.timeout||200)};(self.Astro||(self.Astro={})).idle=l;window.dispatchEvent(new Event(\"astro:idle\"));})();"],["load","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).load=e;window.dispatchEvent(new Event(\"astro:load\"));})();"],["media","(()=>{var n=(a,t)=>{let i=async()=>{await(await a())()};if(t.value){let e=matchMedia(t.value);e.matches?i():e.addEventListener(\"change\",i,{once:!0})}};(self.Astro||(self.Astro={})).media=n;window.dispatchEvent(new Event(\"astro:media\"));})();"],["only","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).only=e;window.dispatchEvent(new Event(\"astro:only\"));})();"],["visible","(()=>{var a=(s,i,o)=>{let r=async()=>{await(await s())()},t=typeof i.value==\"object\"?i.value:void 0,c={rootMargin:t==null?void 0:t.rootMargin},n=new IntersectionObserver(e=>{for(let l of e)if(l.isIntersecting){n.disconnect(),r();break}},c);for(let e of o.children)n.observe(e)};(self.Astro||(self.Astro={})).visible=a;window.dispatchEvent(new Event(\"astro:visible\"));})();"]],"entryModules":{"\u0000virtual:astro:actions/noop-entrypoint":"chunks/noop-entrypoint_DsBX4kaI.mjs","\u0000noop-middleware":"virtual_astro_middleware.mjs","\u0000virtual:astro:session-driver":"chunks/_virtual_astro_session-driver_Csu6PJY6.mjs","\u0000virtual:astro:server-island-manifest":"chunks/_virtual_astro_server-island-manifest_CFl7y3Qj.mjs","\u0000virtual:astro:page:src/pages/posts/[slug]@_@astro":"chunks/_slug__f01piirS.mjs","\u0000virtual:astro:page:src/pages/index@_@astro":"chunks/index_xEsFZ3kW.mjs","/Users/Rohin1/code/github.com/website/.astro/content-assets.mjs":"chunks/content-assets_CL5hQMHo.mjs","/Users/Rohin1/code/github.com/website/.astro/content-modules.mjs":"chunks/content-modules_Uxt4s84c.mjs","\u0000astro:data-layer-content":"chunks/_astro_data-layer-content_8tEa4_uZ.mjs","/Users/Rohin1/code/github.com/website/node_modules/@astrojs/cloudflare/dist/entrypoints/image-service-workerd.js":"chunks/image-service-workerd_CChWldUZ.mjs","virtual:cloudflare/worker-entry":"entry.mjs","/Users/Rohin1/code/github.com/website/src/components/ThemeToggle.astro?astro&type=script&index=0&lang.ts":"_astro/ThemeToggle.astro_astro_type_script_index_0_lang.DmaIJ5dO.js","astro:scripts/before-hydration.js":""},"inlinedScripts":[["/Users/Rohin1/code/github.com/website/src/components/ThemeToggle.astro?astro&type=script&index=0&lang.ts","globalThis.process??={};globalThis.process.env??={};const o=document.querySelector(\".theme-toggle\");o?.addEventListener(\"click\",()=>{const t=document.documentElement,e=t.getAttribute(\"data-theme\")===\"dark\"?\"light\":\"dark\";t.setAttribute(\"data-theme\",e),localStorage.setItem(\"theme\",e)});"]],"assets":["/favicon.ico","/favicon.svg","/index.html"],"buildFormat":"directory","checkOrigin":true,"actionBodySizeLimit":1048576,"serverIslandBodySizeLimit":1048576,"allowedDomains":[],"key":"SGSR23f8Qx722vK42YLMl4+yFZqRE+sHzEgDF/hIWas=","sessionConfig":{"driver":"unstorage/drivers/cloudflare-kv-binding","options":{"binding":"SESSION"}},"image":{},"devToolbar":{"enabled":false,"debugInfoOutput":""},"logLevel":"info","shouldInjectCspMetaTags":false});
